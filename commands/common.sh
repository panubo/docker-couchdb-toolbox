...
HOST=${COUCHDB_HOST-${LINK_PORT_5984_TCP_ADDR-'localhost'}}
PORT=${COUCHDB_PORT-${LINK_PORT_5984_TCP_PORT-'5984'}}
USER=${COUCHDB_USER-${LINK_ENV_COUCHDB_USER-'admin'}}
PASS=${COUCHDB_PASS-${LINK_ENV_COUCHDB_PASS}}
